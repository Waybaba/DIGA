...
class Zurich_night_DataSet(BaseDataset):
    ...
    def get_metadata(self, name):
        img_file = self.root / 'rgb_anon' / self.set / name
        label_name = name.replace("rgb_anon", "gt_labelIds")
        label_file = self.root / 'gt' / self.set / label_name
