...
class SynthiaDataSet(BaseDataset):
    def __init__(self, root, mode, crop_size, maxSkip=0, joint_transform=None, sliding_crop=None,
...
class SynthiaDataSetUniform(BaseDataset):
    """
...
class SynthiaDataSetAug(BaseDataset):
